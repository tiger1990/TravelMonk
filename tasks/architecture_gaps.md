...
interface PasskeyMockDataSource {
fun registrationChallenge(): String
}

Implementation:

class AndroidPasskeyMockDataSource @Inject constructor(
@ApplicationContext private val context: Context
) : PasskeyMockDataSource

Then repository depends on abstraction.
